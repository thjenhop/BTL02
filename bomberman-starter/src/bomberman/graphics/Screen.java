...
public class Screen {
	...
	public void drawStart(Graphics g) {
		...
		g.setFont(font);
		g.setColor(Color.white);
		drawCenteredString("BOMBERMAN", getRealWidth(), getRealHeight(), g);
		
		font = new Font("Arial", Font.PLAIN, 10 * Game.SCALE);
		g.setFont(font);
		g.setColor(Color.yellow);
		drawCenteredString("press space to start", getRealWidth(), getRealHeight() + (Game.TILES_SIZE * 2) * Game.SCALE, g);
	}
